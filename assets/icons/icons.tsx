export function Reaction({ ...props }: React.ComponentPropsWithoutRef<"svg">) {
  return (
...
export function Memory({ ...props }: React.ComponentPropsWithoutRef<"svg">) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" {...props}>
      <path
        stroke="#FFB21E"
...
export function Verbal({ ...props }: React.ComponentPropsWithoutRef<"svg">) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" {...props}>
      <path
        stroke="#00BB8F"
...
export function Visual({ ...props }: React.ComponentPropsWithoutRef<"svg">) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" {...props}>
      <path
        stroke="#1125D6"
